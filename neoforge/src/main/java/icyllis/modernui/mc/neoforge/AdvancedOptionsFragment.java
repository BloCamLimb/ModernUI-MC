...
import static icyllis.modernui.mc.neoforge.PreferencesFragment.*;
...
public class AdvancedOptionsFragment extends Fragment {
    ...
    private static final Field OPTION_VALUE = ObfuscationReflectionHelper.findField(OptionInstance.class, "value");
