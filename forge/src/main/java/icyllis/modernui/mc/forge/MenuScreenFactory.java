 ...
 * }</pre>
 * <p>
 * All menu types are registered with {@link net.minecraftforge.event.RegistryEvent}
 * and {@link net.minecraftforge.registries.ForgeRegistries#CONTAINERS}, use
 ...
 *
 * @see net.minecraftforge.network.NetworkHooks#openGui(ServerPlayer, MenuProvider, Consumer)
 */
@FunctionalInterface
public interface MenuScreenFactory<T extends AbstractContainerMenu> extends
     ...
     * <p>
     * Specially, {@link UICallback} can be returned by {@link #createCallback(AbstractContainerMenu)}
    ...
    @Nullable
    default UICallback createCallback(T menu) {
        return null;
    }
}
